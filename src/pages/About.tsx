    ...
    <Layout>
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="card-glow">
            <h2 className="text-2xl font-bold text-foreground mb-6">Why Choose Klevora?</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Scalable Technology</h3>
                <p className="text-foreground-muted text-sm">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Innovation First</h3>
                <p className="text-foreground-muted text-sm">
